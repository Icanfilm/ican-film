...
// (Note: On GitHub, you can eventually import this from '../components/UI')
...
const Home = ({ navigateTo }) => {
  return (
    <div className="animate-fade-in font-sans selection:bg-red-600 selection:text-white tracking-tighter">
      ...
      <section className="relative h-screen min-h-[900px] flex items-center bg-slate-900 overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-20">
          <div className="max-w-5xl">
            ...
            <p className="text-2xl md:text-4xl text-gray-200 mb-14 max-w-4xl font-medium leading-tight tracking-tight uppercase">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-stretch">
            ...
            <div className="bg-slate-50 p-16 rounded-[4rem] border border-slate-100 flex flex-col justify-center relative group hover:shadow-2xl transition-all duration-500 overflow-hidden">
              <h3 className="text-4xl font-black text-slate-300 mb-12 flex items-center gap-4 uppercase italic tracking-tighter leading-none">
                <Icon name="trendingDown" size={32} /> The Reality
              </h3>
              <div className="space-y-16 relative z-10">
                 <div className="flex items-start gap-8">
                    <div className="bg-white p-6 rounded-3xl shadow-sm text-slate-300 border border-slate-100"><Icon name="clock" size={40} /></div>
                    <div>
                 ...
                 <div className="flex items-start gap-8">
                    <div className="bg-white p-6 rounded-3xl shadow-sm text-slate-300 border border-slate-100"><Icon name="timer" size={40} /></div>
                    <div>
            ...
            <div className="bg-slate-900 p-16 rounded-[4rem] border-4 border-red-600 flex flex-col justify-center relative overflow-hidden shadow-3xl transform hover:scale-[1.03] transition-all duration-700 group">
              ...
              <h3 className="text-4xl font-black text-red-500 mb-12 flex items-center gap-4 relative z-10 uppercase italic tracking-tighter leading-none">
                <Icon name="trendingUp" size={32} /> The ICAN Edge
              </h3>
              <div className="space-y-16 relative z-10">
                 <div className="flex items-start gap-8">
                    ...
                    <div>
                      <p className="text-4xl font-black text-white leading-none mb-3 tracking-tighter uppercase italic">89% ROI</p>
                 ...
                 <div className="flex items-start gap-8">
                    ...
                    <div>
                      <p className="text-4xl font-black text-white leading-none mb-3 tracking-tighter uppercase italic">300% REACH</p>
